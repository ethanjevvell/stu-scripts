    ...
    partial class Program
    {
        public class TEA
        {
            ...
            public string Encrypt(string data, string key)
            {
                ...
                if (data.Length % 2 != 0) data += '\0'; // Make sure array is even length
                byte[] dataBytes = System.Text.ASCIIEncoding.GetBytes(data);
            ...
            public string Decrypt(string data, string key)
            {
                ...
                string decipheredString = System.Text.ASCIIEncoding.GetString(dataBytes, 0, dataBytes.Length);
